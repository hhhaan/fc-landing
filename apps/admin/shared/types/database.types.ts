...
export type Database = {
    ...
    public: {
        ...
        Functions: {
            ...
            create_org_invite: {
                Args: { p_expires_in?: string; p_token: string };
                Returns: string;
            };
            has_workspace_access: { Args: { target_owner: string }; Returns: boolean };
            redeem_org_invite: { Args: { p_token: string }; Returns: string };
            remove_org_member: {
