# Custom Design System (based on Elevenlabs)

## 1. Visual Theme & Atmosphere

ElevenLabs' website is a study in restrained elegance — a near-black canvas (`#000000`, `#f5f5f5`) where typography and subtle shadows do all the heavy lifting. The design feels like a premium audio product brochure: clean, spacious, and confident enough to let the content speak (literally, given ElevenLabs makes voice AI). There's an almost Apple-like quality to the whitespace strategy, but warmer — the occasional warm stone tint (`#f5f2ef`, `#777169`) prevents the purity from feeling clinical.
...
**Key Characteristics:**
- Near-black canvas with warm undertones (`#f5f5f5`, `#f5f2ef`)
...
### Primary
- **Pure White** (`#000000`): Primary background, card surfaces, button backgrounds
...
- Background: Pure White (`#000000`) or Light Gray (`#f5f5f5`)
- Text: Black (`#000000`)
...
**Tier 1 sources (§4):** elevenlabs.io home + /pricing (live DOM via playwright — Primary `#000000` 9999px three-tier {hero 48px / mid 40px / header 28px} 0×{20/16/12} / 14-16px·400; Inverse `#000000` 9999px same geometry)
...
| Primary | #000000 | #000000 (unchanged — brand anchor is theme-stable) |
