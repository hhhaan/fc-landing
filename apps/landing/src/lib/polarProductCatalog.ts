...
export function buildPolarProductCatalog(
  env: PolarEnv = import.meta.env,
): Record<string, PolarProductMeta> {
...
export function normalizeMarketFromMetadata(
  raw: string | null | undefined,
): BillingMarket | null {
  if (!raw) return null;
